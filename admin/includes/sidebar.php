<div id="sidebar-wrapper" class="bg-dark">
    <div class="sidebar-heading bg-dark border-bottom border-secondary">
        Travelers Admin
    </div>
    <div class="list-group list-group-flush">
        <a href="dashboard.php" class="list-group-item list-group-item-action bg-dark active">
        ...
        <a href="bookings.php" class="list-group-item list-group-item-action bg-dark">
            <i class="fas fa-book-open me-2"></i> Booking & Payment
        </a>
